...
// const confereceRouter = express.Router();
...
// const registerConfUserUseCase = new RegisterConfUserUseCase(conferenceRepository)

// const conferenceController = new ConferenceController(createConference,getConferencesByOrganizerId, getConferenceById,getAllConference,registerConfUserUseCase)



// // POST /admins
// confereceRouter.post('/conferece/:id/register', conferenceController.registerConfUserHandler);
...
// export default confereceRouter;